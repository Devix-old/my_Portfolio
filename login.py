...
from recipes import randomrecipes

from app import search_recipe, get_recipe_by_id
...
def home_page():
    if current_user.is_authenticated:
        ...
        username = None
    return render_template('index.html', username=username, recipes=randomrecipes)
...
def remove_recipe(recipe_id):
    user = current_user
    # Assuming `current_user.saved_recipes` is a list of recipe IDs
    try:
